  ...
  private async *generateMockStream(
    ...
    if (toolMessageCount === 1) {
      ...
      for (const char of text) {
        yield { type: "text-delta", id: "txt_1", delta: char };
        await this.delay(25);
      }
      ...
      yield { type: "tool-input-start", id: "tool_1", toolName: "str_replace_editor" };
      yield { type: "tool-input-delta", id: "tool_1", delta: argsStr };
      yield { type: "tool-input-end", id: "tool_1" };
      yield { type: "tool-call", toolCallId: "tool_1", toolName: "str_replace_editor", input: argsStr };
    ...
    if (toolMessageCount === 2) {
      ...
      yield { type: "text-start", id: "txt_2" };
      for (const char of text) {
        yield { type: "text-delta", id: "txt_2", delta: char };
        await this.delay(25);
      }
      yield { type: "text-end", id: "txt_2" };
      ...
      yield { type: "tool-input-start", id: "tool_2", toolName: "str_replace_editor" };
      yield { type: "tool-input-delta", id: "tool_2", delta: argsStr };
      yield { type: "tool-input-end", id: "tool_2" };
      yield { type: "tool-call", toolCallId: "tool_2", toolName: "str_replace_editor", input: argsStr };
    ...
    if (toolMessageCount === 0) {
      ...
      yield { type: "text-start", id: "txt_3" };
      for (const char of text) {
        yield { type: "text-delta", id: "txt_3", delta: char };
        await this.delay(15);
      }
      yield { type: "text-end", id: "txt_3" };
      ...
      yield { type: "tool-input-start", id: "tool_3", toolName: "str_replace_editor" };
      yield { type: "tool-input-delta", id: "tool_3", delta: argsStr };
      yield { type: "tool-input-end", id: "tool_3" };
      yield { type: "tool-call", toolCallId: "tool_3", toolName: "str_replace_editor", input: argsStr };
    ...
    if (toolMessageCount >= 3) {
      ...
      yield { type: "text-start", id: "txt_4" };
      for (const char of text) {
        yield { type: "text-delta", id: "txt_4", delta: char };
        await this.delay(30);
      }
      yield { type: "text-end", id: "txt_4" };
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex gap-4">
        <button onClick={() => setCount(prev => prev - 1)} className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">Decrease</button>
        ...
        <button onClick={() => setCount(prev => prev + 1)} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">Increase</button>
      </div>
    </div>
  );
};
...
export default Counter;`;
  ...
  private getNewStringForReplace(componentType: string): string {
    switch (componentType) {
      ...
      case "card": return '      <div className="p-6 hover:bg-indigo-50 transition-colors">';
      default: return "  const increment = () => setCount(prev => Math.min(prev + 1, 100));";
    }
  }
...
export function getLanguageModel() {
  ...
  if (!apiKey || apiKey === "your-api-key-here") {
    ...
    return new MockLanguageModel("mock-" + MODEL) as any;
  }
